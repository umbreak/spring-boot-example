...
public class ChannelSenderProviderAPI extends ChannelSenderProviderBase {

    public ChannelSenderProviderAPI(SurveyController surveyController) {
    ...
    public boolean send(SubscriptionEntity subscription) {
        ...
        //TODO: send through API the response to the user
        return true;
    }
}
